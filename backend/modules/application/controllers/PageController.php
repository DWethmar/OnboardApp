...
class PageController extends Controller {
     ...
     * @param integer $application_id Create for application.
     * @return mixed
     */
    public function actionCreate($application_id = null) {
        $model = new Page();

        if (intval($application_id)) { // TODO: check access!
