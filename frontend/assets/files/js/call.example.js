...
(function (onboard, $, key, uid, lang, undefined) {
    onboard.data_url =  'http://api.onboard.branchdev.nl/v1/data/steps';
    onboard.save_url =  'http://api.onboard.branchdev.nl/v1/data/save';
    onboard.key =  key;
    onboard.uid =  uid;
    ...
    s.src = 'http://api.onboard.branchdev.nl/onboard.js';
    s.async = false;
    l.type = 'text/css'
    l.rel = 'stylesheet'
    l.href = 'http://api.onboard.branchdev.nl/onboard.css'
